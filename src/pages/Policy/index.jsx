...
function Policy() {
  return (
    <>
      ...
      <div className="about_2n">
        <h3 className="about_heade">Политика конфиденциальности</h3>
        <div className="about_conten">
          <p className="titl">1. Общие положения</p>
          <p>
            ...
            данных Название компании (далее – Оператор).
          </p>
          <br />
          <p className="parag">
          ...
          <p className="parag">
            ...
            <p className="url"> http://URL_сайта.ru</p>.
          </p>
          <p className="titl">2. Основные понятия, используемые в Политике</p>
          <p className="parag">
          ...
          <p className="parag">1.Фамилия, имя, отчество;</p>
          <p className="parag">2.Электронный адрес;</p>
          <p className="parag">
          ...
          <p className="titl">4. Цели обработки персональных данных</p>
          <p className="parag">
          ...
          <p className="parag">
            ...
            электронной почты <p className="url">почта_владельца_сайта</p> с
          ...
          <p className="parag">
            ...
            <p className="url"> почта_владельца_сайта</p>. Заполняя
          ...
          <p className="parag">
            ...
            <p className="url"> почта_владельца_сайта</p> с пометкой
          ...
          <p className="parag">
            ...
            <p className="url"> почта_владельца_сайта</p> с пометкой «Отзыв
            согласия на обработку персональных данных».
          </p>
          <p className="titl">7. Трансграничная передача персональных данных</p>
          <p className="parag">
          ...
          <p className="titl">8. Заключительные положения</p>
          <p className="parag">
            ...
            <p className="url"> почта_владельца_сайта</p>.
          </p>
          <p className="parag">
          ...
          <p className="parag">
            ...
            Интернет по адресу <p className="url"> http://URL_сайта/policy/</p>.
          </p>
          <div className="line" />
        </div>
      </div>
      <div className="about_3r">
